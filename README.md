...
## Тест-кейс7: Анализ граничных значений суммы кредита в кредитном каклькуляторе
...
Ожидаемый результат: Открыта страница Кредитный калькулятор онлайн — расчёт платежа по кредиту.

2. Ввести в поле сумма кредита значение 20000

Ожидаемый результат: В ползунке отображается 20000

3. Ввести в поле сумма кредита значение 15000000

Ожидаемый результат: В ползунке отображается 1.5e+07

4. Ввести в поле сумма кредита значение 19999

Ожидаемый результат: В ползунке отображается 20000

5. Ввести в поле сумма кредита значение 15000001

Ожидаемый результат: В ползунке отображается 1.5e+07

6. Оставить поле сумма кредита пустым.

Ожидаемый результат: В ползунке отображается 20000

## Тест-кейс 8: ввод в поле суммы кредита значений, состоящих из символов латиницы, кириллицы и спец-символов.
...
Ожидаемый результат: Поле пустое. В ползунке отображается 20000
...
## Тест-кейс 9: Анализ граничных значений суммы кредита при рассчёте на 15 лет
...
Кредит на 7, 10 и 15 лет возможно взять только на сумму от 5 млн ₽ и только под залог"
